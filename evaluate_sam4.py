        ...
        if len(final_images) > 0:
            ...
            if b % 12 == 0:
                if b > 0:
                    ...
                    # prev_labels = activations_and_patches['class_labels']
                    ...
                    # final_labels = np.concatenate([prev_labels, final_labels])
                    # image_activations = np.concatenate([prev_image_activations, image_activations])
                np.savez(
                    "./activations/activations_patches.npz",
                    # **{"activations": activations, "patches": patches, 'image_activations': image_activations, 'class_labels':final_labels},
                ...
                most_important_concepts = helpers.plot_new_histogram(
                    importances, histogram_dir, b, 100
                )
...
if __name__ == "__main__":
    model_path = "./models/Resnetmodel-14.h5"
    ...
    save_crops = "./crops/fossils_leaves_crops/exp5_RELU_192_20_v11"
    histogram_dir = "./histogram/exp5_RELU_192_20_v11"

    model = helpers.get_resnet_model("Resnet101")
    import ipdb
